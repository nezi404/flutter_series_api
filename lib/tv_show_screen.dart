        ...
        return Container(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children:[
                Text(tvShow!.name, style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold )),
                SizedBox(height: 16),
                ClipRRect(
                  ...
                  SizedBox(height: 16),
                  Text("Web Channel ${tvShow.webChannel}", style: TextStyle(fontSize: 16)),
                  SizedBox(height: 8,),
                  Row(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    mainAxisAlignment: MainAxisAlignment.center, 
                    children: [Text(tvShow.rating == 0.0? 
                  "Nota: N/A" 
                  : "Nota ${tvShow.rating}", style: TextStyle(fontSize: 16)
                  ),
